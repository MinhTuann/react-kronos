            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="group">
                        ...
                        <p className="text-[9px] uppercase tracking-widest text-bone mb-3 font-semibold">Exhibition</p>
                        <h3 className="text-xl  mb-4 group-hover:text-gunmetal transition-colors">The Art of Watches
                    ...
                    <div className="group">
                        ...
                        <p className="text-[9px] uppercase tracking-widest text-bone mb-3 font-semibold">Boutique</p>
                        <h3 className="text-xl  mb-4 group-hover:text-gunmetal transition-colors">New Opening in New
                            York</h3>
                    ...
                    <div className="group">
                        ...
                        <p className="text-[9px] uppercase tracking-widest text-bone mb-3 font-semibold">Craftsmanship</p>
                        <h3 className="text-xl  mb-4 group-hover:text-gunmetal transition-colors">Rare Handcrafts
                            2023</h3>
