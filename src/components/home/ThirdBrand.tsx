        ...
        <section className="py-12 md:py-24 max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                <div className="order-1 space-y-8">
                    <div>
                        <p className="font-branding text-[11px] tracking-[0.3em] uppercase text-golden mb-4">Rolex</p>
                        <h2 className="text-5xl mb-6">1908 <br /> REF. M52508-0008</h2>
                        <p className="text-gunmetal leading-relaxed max-w-md">Elegant, classic and decidedly contemporary, the Perpetual 1908 immortalizes Rolex’s age-long daring spirit. Heir to the brand’s aesthetic heritage as much as to its numerous innovations in watchmaking, the watch perpetuates the brand’s pursuit of excellence. This fine example of Rolex’s watchmaking prowess, with Superlative Chronometer certification, brings classicism to the future.</p>
                    </div>
                    <div className="grid grid-cols-2 gap-y-8 gap-x-12 border-t border-bone/30 pt-8">
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-bone mb-1">Size</p>
                            <p>41 mm</p>
                        </div>
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-bone mb-1">Material</p>
                            <p>White Gold</p>
                        </div>
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-bone mb-1">Movement</p>
                            <p>Manual</p>
                        </div>
                        <div>
                            <p className="text-[9px] uppercase tracking-widest text-bone mb-1">Strap</p>
                            <p>Alligator</p>
                        </div>
                    </div>
                ...
                <div className="order-2 aspect-square overflow-hidden rounded-2xl">
