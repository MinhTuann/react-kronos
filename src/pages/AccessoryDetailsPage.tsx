...
const AccessoryDetailsPage: React.FC = () => {
    ...
    useSeo({
        ...
        canonicalPath: accessory?.canonical_url ? undefined : (id ? `/accessory/${id}` : (brand_slug && ref ? `/accessory/${brand_slug}/${collection_slug ? collection_slug + '/' : ''}${ref}` : '/accessories')),
        ...
        structuredData: accessory ? [
            ...
            createBreadcrumbJsonLd(origin, [
                ...
                { 
                    name: accessory.name, 
                    path: id ? `/accessory/${id}` : `/accessory/${brand_slug}/${collection_slug ? collection_slug + '/' : ''}${ref}` 
                },
            ]),
        ] : undefined,
    });
